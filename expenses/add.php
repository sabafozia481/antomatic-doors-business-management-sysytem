...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($amount) || empty($date)) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO expenses (amount, description, date, added_by) VALUES (?, ?, ?, ?)");
            $stmt->execute([$amount, $description, $date, $added_by]);
            redirect('index.php', "Expense added successfully!");
    ...
    <div style="padding: 24px;">
        <form action="add.php" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" rows="3" placeholder="e.g. Fuel, Material Purchase, Office Rent"></textarea>
            </div>
